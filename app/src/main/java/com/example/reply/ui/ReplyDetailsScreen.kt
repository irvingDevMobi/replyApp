    ...
    Box(modifier = modifier) {
        LazyColumn(
            ...
            item {
                ...
                val paddingValue =
                    dimensionResource(id = R.dimen.detail_card_outer_padding_horizontal)
                ReplyEmailDetailsCard(
                    email = replyUiState.currentSelectedEmail,
                    mailboxType = replyUiState.currentMailbox,
                    isFullScreen = isFullScreen,
                    modifier = if (isFullScreen) Modifier.padding(horizontal = paddingValue)
                    else Modifier.padding(end = paddingValue)
                )
            }
        }
    }
...
private fun ReplyEmailDetailsCard(
    ...
    Card(
        ...
        Column(
            ...
            val topPadding = dimensionResource(R.dimen.detail_content_padding_top)
            if (isFullScreen) {
